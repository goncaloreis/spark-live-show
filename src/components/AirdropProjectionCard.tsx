  ...
  return (
    <Card className="card-premium border-white/5 group hover:border-primary/20 transition-all duration-300 overflow-hidden">
      ...
      <div className="relative p-4 sm:p-5">
        ...
        {/* Main Content - Stack on Mobile, Horizontal on Desktop */}
        <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
          {/* Slider Section */}
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-2">
              <span className="text-[10px] sm:text-[11px] text-muted-foreground uppercase tracking-wider">Conversion Rate</span>
          ...
          {/* Results Section */}
          <div className="flex items-center justify-around md:justify-center gap-6 md:gap-4">
            {/* Estimated SPK */}
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-0.5">
                <Coins className="w-3 h-3 text-primary/60" />
                <span className="text-[9px] sm:text-[10px] text-muted-foreground uppercase tracking-wider">Est. SPK</span>
              </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-0.5">
                ...
                <span className="text-[9px] sm:text-[10px] text-muted-foreground uppercase tracking-wider">Est. Value</span>
              </div>
        ...
        <div className="mt-3 sm:mt-4 pt-2 sm:pt-3 border-t border-white/5">
          <p className="text-[9px] sm:text-[10px] text-muted-foreground/40 text-center font-mono break-all">
