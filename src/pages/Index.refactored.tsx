              ...
              <div className="relative group">
                ...
                <Card className="relative card-premium border shadow-elevated">
                  <div className="p-6 sm:p-8">
                    ...
                    <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground bg-muted/30 rounded-lg px-3 py-2 mt-4 border border-border/50">
